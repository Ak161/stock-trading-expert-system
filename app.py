...
# 页面配置与标题
# =========================
st.set_page_config(layout="wide", page_title=" 交易专家系统 Pro")
st.title("📈  交易专家系统 Pro（量价深度分析版）")
st.markdown("""
本系统基于“ 而为”核心逻辑：**20日线定趋势，量价配合定买点，动态止损定生死。**
""")
...
def analyze_market_structure(df):
    ...
    if is_uptrend:
        if is_volume_breakout:
            status = "🔥 主升浪突破"
            advice = "市场情绪高涨，资金积极涌入，趋势加速确立。可考虑 介入或加仓，但需注意风险控制。"
